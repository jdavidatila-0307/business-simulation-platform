        ...
        if (productos) {
          for (const prod of productos) {
            ...
            const prodConEstado = {
              ...
              equipo: decisionObj.equipo,
              equipoNombre: decisionObj.equipoNombre,
              investigacion: decisionObj.investigacion,
              activosFijosBrutos: decisionObj.activosFijosBrutos,
              amortizacionAcumulada: decisionObj.amortizacionAcumulada,
              baseDepreciable: decisionObj.baseDepreciable,
              baseDepreciableComputo: decisionObj.baseDepreciableComputo,
              baseDepreciableMaquinaria: decisionObj.baseDepreciableMaquinaria,
              baseDepreciableMuebles: decisionObj.baseDepreciableMuebles,
              baseDepreciableVehiculos: decisionObj.baseDepreciableVehiculos,
              depreciacionAcumulada: decisionObj.depreciacionAcumulada,
              intangiblesBrutos: decisionObj.intangiblesBrutos,
              incrementoCapacidadPendiente: decisionObj.incrementoCapacidadPendiente,
              gastoAdminFijo: decisionObj.gastoAdminFijo,
              gastoFijoPlanta: decisionObj.gastoFijoPlanta,
              sueldosAdministrativosFijos: decisionObj.sueldosAdministrativosFijos,
              proveedorElegido: decisionObj.proveedorElegido,
              cantidadMPpedida: decisionObj.cantidadMPpedida,
              contratarOperarios: decisionObj.contratarOperarios,
              despedirOperarios: decisionObj.despedirOperarios,
              montoCapacitacion: decisionObj.montoCapacitacion,
              contratarVendedores: decisionObj.contratarVendedores,
              despedirVendedores: decisionObj.despedirVendedores,
            };
            await pool.query(
    ...
    if (n > 1) {
      ...
      if (prevRonda) {
        ...
        for (const eq of equipos) {
          ...
          const resObjValues = Object.values(resObj).filter(v => v && typeof v === 'object' && (v.equipoOriginal || v.equipo));
